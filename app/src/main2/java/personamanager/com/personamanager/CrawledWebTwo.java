 ...
 */
public class CrawledWebTwo extends AppCompatActivity {
    String url = "http://www.dailymail.co.uk/news/mostread/index.html";
    ListView mListView;
    ...
    public class ParseURL extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog = new ProgressDialog(CrawledWebTwo.this);
            progressDialog.setTitle("");
            progressDialog.setMessage("Crawling Dailymail...");
        ...
        protected Void doInBackground(Void...params) {
            try{
                ...
                Elements headlines = document.select("li a .pufftext strong");
                for (Element headline : headlines) {
                    mData.add(headline.text());
                    mData.add(headline.attr("abs:href"));
                }
