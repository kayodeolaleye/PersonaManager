 ...
 */
public class CrawledWebThree extends AppCompatActivity {
    String url = "http://dailypost.ng/dailystar/news";
    ListView mListView;
    ...
    public class ParseURL extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            progressDialog = new ProgressDialog(CrawledWebThree.this);
            progressDialog.setTitle("");
            progressDialog.setMessage("Crawling dailypost.ng...");
        ...
        protected Void doInBackground(Void...params) {
            try{
                ...
                Elements headlines = document.select(".hdln .linkro-darkred .title");
